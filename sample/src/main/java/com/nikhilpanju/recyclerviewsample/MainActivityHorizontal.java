...
public class MainActivityHorizontal extends AppCompatActivity implements RecyclerTouchListener.RecyclerTouchListenerHelper {
    ...
    private class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder> {
        ...
        public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = inflater.inflate(R.layout.recycler_horizontal_row, parent, false);
